 ...
 * @author Haritha
 */
public class AddFeespage extends JFrame {
    /**
...
public int getBillNo()
{
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement("select max(billNo) from tblfees");
...
public String insertdata()
{
    ...
    try {
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/feesmanagmentdb","nibm","root");
        PreparedStatement ps = con.prepareStatement("insert into tblfees values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
        ps.setInt(1, billno);
        ...
        ps.setString(7, chequnumber);
        ps.setString(8, Bday);
         ps.setString(9, course);
         ps.setString(10, year);
          ps.setString(11, semster);
           ps.setString(12, amount);
            ps.setString(13, tax);
             ps.setString(14, resitationFee);
              ps.setString(15, total);
               ps.setString(16, paymentDetails);
               ps.setString(17, totalword);
...
panelLogout.setBackground(clrout);        // TODO add your handling code here:
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        if(validation()==true)
        {
            ...
            {
                JOptionPane.showMessageDialog(this, "record insert complete");
                PrintResiptPage print = new PrintResiptPage();
                print.setVisible(true);
                this.dispose();
            }
            else{
                JOptionPane.showMessageDialog(this, "record not insertded");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddFeespage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddFeespage().setVisible(true);
            }
        });
    }
